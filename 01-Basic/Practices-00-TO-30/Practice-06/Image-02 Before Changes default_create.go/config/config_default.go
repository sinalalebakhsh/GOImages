...
// An individual configuration setting can be requested by separating a
// section name from a setting name, such as logging:level, 
// or a map containing all of the settings can be
// requested using a section name, such as logging.
